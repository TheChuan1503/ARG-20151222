...
- [发展](#发展)
  ...
  - [8. \[视频\] record20190809\_215847\_231042](#8-视频-record20190809_215847_231042)
    - [视频外信息](#视频外信息-2)
    - [视频内信息](#视频内信息-2)
  - [\[网站内容变更\] 2025-08-10](#网站内容变更-2025-08-10)
  - [9. \[视频\] record20190811\_062456\_080223](#9-视频-record20190811_062456_080223)
...
- 网站背景是 `record20190722_085432_224655`，网站是一个弹幕小游戏，`A` `D` 移动，`空格` 跳跃  
  此网站在后面的视频有用到  
...
- 新增文章 `2019社会观察报 - 游戏业寒冬加剧：多地小团队创始人失联，行业洗牌加速`，并且在所有文章上增加了目录  
  ...
  <img src="img/2/e2.png" alt="" width="240px">
...
## [网站内容变更] 2025-08-10
> `www.gonethings.cloud/■■■record`

- 黄色为HTML注释  
  <img src="img/2/e4.png" alt="" width="240px">

## 9. [视频] record20190811_062456_080223
> **时间** 2025-08-11 08:13:06  
> **BV**1iPbuzkEsE  
> **简介** two

- `00:30` 睡觉时出现了数独和坐标 `Y: D1 G8 F6`  
  <img src="img/2/v9.1.png" alt="" width="240px">  
  <img src="img/2/v9.2.jpg" alt="" width="240px">  
  _图二转自 bilibili@drea_MR_an_  
  表明Y坐标是 `138` 

## 10. [动态] Interference release
> **时间** 2025-08-11 09:40  
> <img src="img/2/s10.1.png" alt="" width="240px">

## 11. [视频] record20190812_145612_174232
> **文件名** 加载错误，请重试  
> **时间** 2025-08-12 17:20:00  
> **BV**1WNtozWECC  
> **简介** three

- `02:02` 主视角挖开石头后掉进了一个诡异的洞，并且伴随着打雷声和频谱图隐写  
  <img src="img/2/v11.1.png" alt="" width="240px">  
  <img src="img/2/v11.5.png" alt="" width="240px">  
  频谱图是上次数独

- `02:08` byd还有数学题  
  <img src="img/2/v11.2.png" alt="" width="240px">  
  解得 `85`，也就是Z坐标是 `85`，最后得出坐标是 `142, 138, 85`

- `02:44` 左侧岩浆变成了奇怪的物体  
  <img src="img/2/v11.3.png" alt="" width="240px">
