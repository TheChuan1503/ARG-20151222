...
## 须知
### 普通结局已达成
- 梁才奇在2019-01-02 13:17从现实的床上醒来，结束了第一季
...
- [ARG-20151222 (旧)](#arg-20151222-旧)
    - [更新时间 `2025-07-18`](#更新时间-2025-07-18)
  - [须知](#须知)
    - [普通结局已达成](#普通结局已达成)
    - [网站内容请看](#网站内容请看)
    - [游戏存档请看](#游戏存档请看)
...
- **文件是一个mc存档**
  ...
  存档截图  
  ![存档截图](img/world_7.jpg)  
  ![存档截图](img/world_6.jpg)  
  ![存档截图](img/world_5.jpg)  
  ![存档截图](img/world_4.jpg)  
  ![存档截图](img/world_3.jpg)  
  ![存档截图](img/world_2.jpg)  
  ![存档截图](img/world_1.jpg)
...
- 简介为base64，解码后得到  
  ...
  No
  So...fix it
  No,it might be very interesting:)
  ```
